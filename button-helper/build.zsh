...
xcrun clang -fobjc-arc -Wall -Wextra -Wno-unused-parameter -Wno-deprecated-declarations -arch arm64 -mmacosx-version-min=14.0 ScanJetButton.m ScanOutput.m ProcessingQueue.m ScannerRecovery.m ../build/ButtonUSB.o -framework AppKit -framework ImageCaptureCore -framework PDFKit -framework ImageIO -framework IOKit -o "$app/Contents/MacOS/ScanJet Button"
